...
function CRUserData(userData) {
    ...
    userData.forEach(function (item) {
        $('#user-row').append(`<tr class="d-flex row file-item col-md-12 waves-effect" idUser="${item.id}" ">
                                    ...
                                    <td class="col-2 list-view-dataused"></td>
                                    <td class="col-1 list-view-folder-count"></td>
                                    <td class="col-1 list-view-file-count"></td>
...
function CRAdminData(adminData) {
    ...
    adminData.forEach(function (item) {
        $('#admin-row').append(`<tr class="d-flex row file-item col-md-12 waves-effect" idUser="${item.id}" ">
